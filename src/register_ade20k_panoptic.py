...
# Copied from: https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/data/datasets/register_ade20k_panoptic.py

# Modify this if you want to change the definition of "traversable"
